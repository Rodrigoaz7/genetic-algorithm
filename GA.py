...
best = geneticAlgorithm(population=cities, popSize=100, eliteSize=20, mutationRate=0.01, generations=500)
...
plt.plot([best2array[i % 15][0] for i in range(16)], [best2array[i % 15][1] for i in range(16)], 'xb-');
plt.show()